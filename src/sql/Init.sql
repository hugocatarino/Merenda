...
INSERT INTO `Merenda`.`Estoque` (Escola_idEscola, nome) VALUES (1, "mais educação");
...
INSERT INTO `Merenda`.`Alimento` (nome, Estoque_idEstoque, total)
	VALUES ("Açafrão", 1, 300);
INSERT INTO Remessa_has_Alimento (Remessa_idRemessa, Alimento_idAlimento, tipo, peso_liq, quantidade, falta, recebido) 
	VALUES(1, 1, 2, 100, 03, 2, 300);
